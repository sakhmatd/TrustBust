...
for x in range(256):
    with open(f"csv/trustbust_data_{x}.csv", mode='r', newline='') as f:
...
plt.title('CPA Correlation per Key Guess')
plt.grid(True)
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', fontsize='xx-small')  # Legend on the side
plt.savefig('all_keyguesses_cpa_plot.png', dpi=300)